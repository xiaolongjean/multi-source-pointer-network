...
class BeamSearch:
    ...
    def search(self,
        ...
        for key, state_tensor in state.items():
            ...
            # shape: (batch_size * beam_size, *)
            state[key] = state_tensor.unsqueeze(1)\
        ...
        for timestep in range(self.max_steps - 1):
            ...
            # shape: (batch_size * beam_size, num_classes)
            last_predicted_global_ids = state["merged_source_global_ids"]\
                .gather(-1, last_predictions.unsqueeze(1)).squeeze(-1)
            ...
            for key, state_tensor in state.items():
                ...
                # shape: (batch_size * beam_size, *)
                state[key] = state_tensor.reshape(batch_size, self.beam_size, *last_dims)\
