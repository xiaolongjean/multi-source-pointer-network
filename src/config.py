...
def config():
    ...
    parser.add_argument("-numpy_random_seed", "--numpy_random_seed", type=int, default=1001, help="random seed for numpy.")
    parser.add_argument("-torch_random_seed", "--torch_random_seed", type=int, default=1002, help="random seed for torch.")

    group = parser.add_argument_group("path")
    group.add_argument("-train_data_path", "--train_data_path", type=str, default="../data/train.dat", help="Training data path.")
    group.add_argument("-valid_data_path", "--valid_data_path", type=str, default="../data/valid.dat", help="validation data path.")
    group.add_argument("-test_data_path",  "--test_data_path",  type=str, default=None,  help="Test data path.")
    ...
    group.add_argument("-use_position_emb", "--use_position_emb", type=bool, default=True, help="flag use positional embedding.")
    group.add_argument("-flag_use_layernorm", "--flag_use_layernorm", type=bool, default=False, help="flag use layernorm.")
    ...
    group.add_argument("-traing_patience", "--traing_patience", type=int, default=10, help="patience for early stopping.")
    group.add_argument('-dropout_keep_prob', "--dropout_keep_prob", type=float, default=0.9, help='dropout probability')
    group.add_argument("-grad_norm", "--grad_norm", type=float, default=5.0, help="Maximum value of gradient norm,")
    group.add_argument("-lr_patience", "--lr_patience", type=int, default=5, help="Patience for reducing learning rate.")
    group.add_argument("-flag_clip_grad", "--flag_clip_grad", type=bool, default=True, help="Flag whether clip the grad.")
    group.add_argument("-flag_lr_schedule", "--flag_lr_schedule", type=bool, default=True, help="Flag whether scheduling lr.")
    
    group = parser.add_argument_group("test")
    group.add_argument("-beam_size", "--beam_size", type=int, default=3, help="Beam size.")
    group.add_argument("-max_decoding_steps", "--max_decoding_steps", type=int, default=5, help="Maximum decoding steps")
